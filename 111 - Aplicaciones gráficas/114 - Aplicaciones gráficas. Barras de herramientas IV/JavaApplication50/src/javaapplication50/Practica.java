    ...
    {    
      ...
      /* JCheckBoxMenuItem negrita = new JCheckBoxMenuItem("Negrita",new ImageIcon("src/javaapplication50/copiar.gif"));
       ...
       tamano.add(veinticuatro);
        ...
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.BoldAction());
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.ItalicAction());
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.UnderlineAction());
        
        barra.addSeparator();
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.ForegroundAction("Pone_azul",Color.BLUE));
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.ForegroundAction("Pone_azul",Color.RED));
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.ForegroundAction("Pone_azul",Color.YELLOW));
        
        barra.addSeparator();
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.AlignmentAction("izquierda",0));
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.AlignmentAction("derecha",2));
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.AlignmentAction("centrado",1));
        
        configura_barra("src/azul.png").addActionListener(new StyledEditorKit.AlignmentAction("justificado",3));
