    ...
    private class AccionMostrar implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(lamina_tipo.dameSeleccion().equals("Mensaje"))
            {
                ...
                JOptionPane.showMessageDialog(Marco_Dialogos.this,dameMensaje(),"Título",dameIcono());
                
            }
            else if(lamina_tipo.dameSeleccion().equals("Confirmar"))
            {
                
                JOptionPane.showConfirmDialog(Marco_Dialogos.this,dameMensaje(),"Título",0,dameIcono());
            ...
            else if(lamina_tipo.dameSeleccion().equals("Opción"))
            {
                ...
                JOptionPane.showOptionDialog(Marco_Dialogos.this,dameMensaje(),"Título",0,dameIcono(),null,null,null);
