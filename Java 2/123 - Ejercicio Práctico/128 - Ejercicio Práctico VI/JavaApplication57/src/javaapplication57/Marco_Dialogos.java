    ...
    private class AccionMostrar implements ActionListener
    {
        ...
        public void actionPerformed(ActionEvent ae) {
            ...
            if(lamina_tipo.dameSeleccion().equals("Mensaje"))
            {
                ...
                JOptionPane.showMessageDialog(Marco_Dialogos.this,dameMensaje(),"Título",0);
            ...
            else if(lamina_tipo.dameSeleccion().equals("Opción"))
            {
                ...
                JOptionPane.showOptionDialog(Marco_Dialogos.this,dameMensaje(),"Título",0,0,null,null,null);
