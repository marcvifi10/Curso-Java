        ...
        private class Accion_botones implements ActionListener
        {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                else if(e.getSource()==boton3)
                {
                    ...
                    JOptionPane.showConfirmDialog(Lamina_Cuadros_Dialogos.this,"Elige Opción","V_Confirmar",1);
                ...
                else
                {
                   // System.out.println("Has pulsado el boton4");
                    ...
                    JOptionPane.showOptionDialog(Lamina_Cuadros_Dialogos.this,"Elige","Titulo",1,1,null,null,null);
