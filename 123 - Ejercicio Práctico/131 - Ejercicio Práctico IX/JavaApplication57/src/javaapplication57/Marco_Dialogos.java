...
public class Marco_Dialogos extends JFrame {
    ...
    public Object[] dameOpciones(Lamina_Botones lamina)
    {
        ...
        else if(s.equals("Icon[]"))
        {
            ...
            ImageIcon iconoAzul = new ImageIcon("src/azul.jpg"); 
            Image image1 = iconoAzul.getImage();  
            Image azul = image1.getScaledInstance(10, 10,  java.awt.Image.SCALE_SMOOTH); 
            
            ImageIcon iconoAmarillo = new ImageIcon("src/amarillo.jpg"); 
            Image image2 = iconoAmarillo.getImage();  
            Image amarillo = image2.getScaledInstance(10, 10,  java.awt.Image.SCALE_SMOOTH); 
            
            ImageIcon iconoRojo = new ImageIcon("src/rojo.jpg"); 
            Image image3 = iconoRojo.getImage();  
            Image rojo = image3.getScaledInstance(10, 10,  java.awt.Image.SCALE_SMOOTH); 
            
            return new Object[]{new ImageIcon(azul),new ImageIcon(amarillo),new ImageIcon(rojo)};
